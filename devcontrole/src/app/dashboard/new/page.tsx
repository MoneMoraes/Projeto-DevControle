        ...
        <Container>
            <main className="mt-9 mb-2">
                ...
                <form className="flex flex-col mt-6" action={handleRegisterTicket}>
                    ...
                    <input 
                        className="w-full border-2 rouded-md px-2 mb-2 h-11"
                        type="text"
                    ...
                    <button 
                        type="submit"
                        className="bg-blue-500 text-white font-bold px-2 h-11 rounded-md my-4 disabled:bg-gray-400 desabled:cursor-not-allowed"
