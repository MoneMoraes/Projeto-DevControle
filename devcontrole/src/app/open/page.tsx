...
const schema = z.object({
    email: z.string().email("Digite o email do cliente para localizar.").min(1, "O campo email é obrigadotório")
})
        ...
        <div className="w-full max-w-2xl mx-auto px-2">
            ...
            <main className="flex flex-col mt-4 mb-2">
                ...
                {customer ? (
                    ...
                    <form className='bg-slate-200 py-6 px-2 rouded border-2' onSubmit={handleSubmit(handleSearchCustomer)}>
